...
class ApplicationConfigHealthchecksPage extends StatelessWidget {
  const ApplicationConfigHealthchecksPage({
    super.key,
  ...
  Widget build(BuildContext context) {
    return ApplicationConfigSectionEditor(
      ...
      fields: ApplicationConfigSchema.healthCheckFields,
      onUpdated: onUpdated,
    );
  }
}
